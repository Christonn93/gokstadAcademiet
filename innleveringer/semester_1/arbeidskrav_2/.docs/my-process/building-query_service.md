# How I built the query_service

> After some feedback on that I have to much code files from Marius, I decided to look into building a class service

I have talked with AI, been reading documents and trying out different ways to build out the class. 
The results of the class is built based on documentations, strategic sparring with AI and learning the core of how class is working. 

I asked AI to help me understand python class, it generated [this](/.docs/AI-Help/learning_python_class_basics_with_real-world_examples.md)

After building out the class, I started question if its actually needed to be as a class. Since each function is not using the self params. 
...
After asking AI, discussing back and forth I decided to split it into smaller class services. One for book, one for loan and one for borrower. 
